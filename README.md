...
<h3 align="center">SIT.Manager.Avalonia</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/stayintarkov/SIT.Manager.Avalonia"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/stayintarkov/SIT.Manager.Avalonia">View Demo</a>
    ·
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `stayintarkov`, `SIT.Manager.Avalonia`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `SIT.Manager.Avalonia`, `An Avalonia based manager for launching and managingSIT`
...
2. Clone the repo
   ```sh
   git clone https://github.com/stayintarkov/SIT.Manager.Avalonia.git
   ```
...
Project Link: [https://github.com/stayintarkov/SIT.Manager.Avalonia](https://github.com/stayintarkov/SIT.Manager.Avalonia)
